...
setTimeout(() => {
    ...
    var config = { attribudes: true, childList: true, subtree: true };

    var observer = new MutationObserver((murationList) => {
        for (var muration of murationList) {
            if (muration.type == "childList") {
    ...
    observer.observe(open_modal, config);
}, 5000);
